...
# CUDA_VISIBLE_DEVICES=6 python metrics.py --scene_config scene_config.json -r density --refinement_time short
# CUDA_VISIBLE_DEVICES=6 python metrics.py --scene_config scene_config.json -r density --refinement_time short --use_uv_texture True
# CUDA_VISIBLE_DEVICES=6 python metrics.py --scene_config scene_config_2.json -r density --refinement_time short --use_uv_texture
import argparse
import os
import json
